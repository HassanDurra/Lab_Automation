...
<div class="col-md-6 ">
<h1>Send For Re-testing</h1>

<form method="POST" action="/retestupdate{{$cd[0]->Product_id}}" enctype="multipart/form-data">
...
<button type="submit" class="">Send For Re-testing</button>
</div>
